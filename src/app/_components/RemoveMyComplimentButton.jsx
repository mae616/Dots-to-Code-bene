...
export default function RemoveMyComplimentButton({ complimentId }) {
  ...
  const { removeCompliment, removeLoading, removeError, setRemoveError } =
    useRemoveMyCompliment(complimentId);
    ...
    <>
          ...
          return (
            <div className="bg-white border-round p-3">
              <span className="text-sm">
                <i className="pi pi-exclamation-triangle text-red-400 pr-1" />
                {message}
              </span>
              <div className="flex align-items-center gap-2 mt-3">
                <Button
                  ...
                  severity="danger"
                  className="p-button-sm p-button-outlined border-red-400 text-red-400 hover:border-red-700 hover:bg-red-200"
                />
                <Button
                  ref={rejectBtnRef}
                  label="キャンセル"
      ...
      <div className="flex justify-end items-center">
        <div
          ...
          className="m-0 cursor-pointer text-sm text-red-400 hover:text-red-700"
        >
