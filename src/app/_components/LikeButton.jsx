...
export default function LikeButton({isLiked = false, countOfLikes = 0, complimentId}) {
  ...
  if(isLiked){
    return (
        <div className="flex items-center hover:cursor-pointer px-2 z-10" onClick={(e)=>{ e.preventDefault(); removeLike(complimentId); }} >
    ...
    return (
      <div className="flex items-center hover:cursor-pointer px-2 z-10" onClick={(e)=>{ e.preventDefault(); addLike(complimentId); }} >
