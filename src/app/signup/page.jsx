...
export default function Signup() {
  ...
  return (
    <div className="text-center pt-20 px-8">
      <h1 className={ZenMaruGothic.className + " text-lg my-3"}>
        <Link href="/">ほめるん</Link>
      </h1>
      <form
        onSubmit={(e) => {
      ...
      <div className="flex justify-center items-center">
        <FontAwesomeIcon
          ...
          className="h-[12px] text-slate-500 mr-2"
        />
        <Link href="/login" className="text-slate-500 text-sm">
          ログイン
        </Link>
      </div>
    </div>
